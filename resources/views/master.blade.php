...
<head>
    <script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-1743240891012775"
  ...
  {{-- <link rel="stylesheet" type="text/css" href="https://cdn.datatables.net/v/bs5/dt-1.13.1/r-2.4.0/sc-2.0.7/sb-1.4.0/datatables.min.css"/> --}}
  <!-- BEGIN: Vendor CSS-->
  <link rel="stylesheet" type="text/css" href="{{ asset('/front')}}/app-assets/vendors/css/vendors.min.css">
  <link rel="stylesheet" type="text/css" href="{{ asset('/front')}}/app-assets/vendors/css/tables/datatable/dataTables.bootstrap5.min.css">
    <link rel="stylesheet" type="text/css" href="{{ asset('/front')}}/app-assets/vendors/css/tables/datatable/responsive.bootstrap5.min.css">
    <link rel="stylesheet" type="text/css" href="{{ asset('/front')}}/app-assets/vendors/css/tables/datatable/buttons.bootstrap5.min.css">
    <link rel="stylesheet" type="text/css" href="{{ asset('/front')}}/app-assets/vendors/css/tables/datatable/rowGroup.bootstrap5.min.css">
...
<body class="horizontal-layout horizontal-menu  navbar-floating footer-static  antialiased" data-open="hover"
  ...
  <script src="{{ asset('/front')}}/app-assets/vendors/js/tables/datatable/dataTables.bootstrap5.min.js"></script>
  <script src="{{ asset('/front')}}/app-assets/vendors/js/tables/datatable/dataTables.responsive.min.js"></script>
  <script src="{{ asset('/front')}}/app-assets/vendors/js/tables/datatable/responsive.bootstrap5.js"></script>
  <script src="{{ asset('/front')}}/app-assets/js/scripts/tables/table-datatables-advanced.min.js"></script>
  <script src="{{ asset('/front')}}/app-assets/js/scripts/tables/table-datatables-basic.min.js"></script>
      <!-- BEGIN: Page JS-->
{{-- <script type="text/javascript" src="https://cdn.datatables.net/v/bs5/dt-1.13.1/r-2.4.0/sc-2.0.7/sb-1.4.0/datatables.min.js"></script> --}}
